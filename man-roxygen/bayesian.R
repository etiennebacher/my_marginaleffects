...
#' option:
#' 
#' `options("my_marginaleffects_posterior_interval" = "eti")`
#' 
#' `options("my_marginaleffects_posterior_interval" = "hdi")`
#' 
...
#' global option:
#' 
#' `options("my_marginaleffects_posterior_center" = "mean")`
#' 
#' `options("my_marginaleffects_posterior_center" = "median")`
#' 
...
#' `"my_marginaleffects_posterior_center"` option (the median by default).
#' 
