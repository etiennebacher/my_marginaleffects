...
get_predict.default <- function(model,
    ...
    # matrix with outcome levels as columns
        ...
        stop(sprintf("Unable to extract predictions of type %s from a model of class %s. Please report this problem, along with reproducible code and data on Github: https://github.com/vincentarelbundock/my_marginaleffects/issues", type, class(model)[1]), call. = FALSE)
    }
