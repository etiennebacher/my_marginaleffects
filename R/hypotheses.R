...
#' 
#' * <https://my_marginaleffects.com/vignettes/hypothesis.html>
...
#' 
#' Warning #2: For hypothesis tests on objects produced by the `my_marginaleffects` package, it is safer to use the `hypothesis` argument of the original function.  Using `hypotheses()` may not work in certain environments, in lists, or when working programmatically with *apply style functions.
#' 
...
#' 
#' # joint hypotheses: my_marginaleffects object
...
hypotheses <- function(
    ...
    # my_marginaleffects objects: recall()
