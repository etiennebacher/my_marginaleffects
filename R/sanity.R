...
#     return_data <- getOption("my_marginaleffects_return_data", default = TRUE)
...
#     numDeriv_method <- getOption("my_marginaleffects_numDeriv_method", default = "simple")
