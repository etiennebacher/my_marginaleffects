#' Print a my_marginaleffects object in knitr
#'
#' @keywords internal
#' @return A string with class `knit_asis` to be printed in Rmarkdown or Quarto documents.
#' @exportS3Method knitr::knit_print
knit_print.my_marginaleffects <- function(x, ...) {
  if (isTRUE(getOption("my_marginaleffects_print_style") == "tinytable")) {
...
#' Print `my_marginaleffects` objects
#' 
#' @description
...
#' 
#' @param x An object produced by one of the `my_marginaleffects` package functions.
...
#' data.frame(p)
#'
print.my_marginaleffects <- function(x,
                                  style = getOption("my_marginaleffects_print_style", default = "summary"),
                                  digits = getOption("my_marginaleffects_print_digits", default = 3),
                                  p_eps = getOption("my_marginaleffects_print_p_eps", default = 0.001),
                                  topn = getOption("my_marginaleffects_print_topn", default = 5),
                                  nrows = getOption("my_marginaleffects_print_nrows", default = 30),
                                  ncols = getOption("my_marginaleffects_print_ncols", default = 30),
                                  type = getOption("my_marginaleffects_print_type", default = TRUE),
                                  column_names = getOption("my_marginaleffects_print_column_names", default = TRUE),
                                  ...) {
    ...
    if ("group" %in% colnames(out) &&
        all(out$group == "main_my_marginaleffects")) {
        out$group <- NULL
    }
    ...
    print_omit <- getOption("my_marginaleffects_print_omit", default = NULL)
    ...
    if (splitprint) {
        ...
        msg <- "--- %s rows omitted. See %s?print.my_marginaleffects ---"
...
#' @noRd
#' @export
print.hypotheses <- print.my_marginaleffects

#' @noRd
#' @export
print.predictions <- print.my_marginaleffects

#' @noRd
#' @export
print.comparisons <- print.my_marginaleffects

#' @noRd
#' @export
print.slopes <- print.my_marginaleffects

#' @noRd
#' @exportS3Method knitr::knit_print
knit_print.hypotheses <- knit_print.my_marginaleffects

#' @noRd
#' @exportS3Method knitr::knit_print
knit_print.predictions <- knit_print.my_marginaleffects

#' @noRd
#' @exportS3Method knitr::knit_print
knit_print.comparisons <- knit_print.my_marginaleffects

#' @noRd
#' @exportS3Method knitr::knit_print
knit_print.slopes <- knit_print.my_marginaleffects
