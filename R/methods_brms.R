...
get_predict.brmsfit <- function(model,
    ...
    # multi-dimensional outcome
        ...
        stop("my_marginaleffects cannot extract posterior draws from this model. Please report this problem to the Bug tracker with a reporducible example: https://github.com/vincentarelbundock/my_marginaleffects/issues", call. = FALSE)
    }
