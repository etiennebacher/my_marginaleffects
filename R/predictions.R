...
#' * <https://my_marginaleffects.com/vignettes/predictions.html>
...
predictions <- function(model,
    ...
    newdata_attr_cache <- get_my_marginaleffects_attributes(newdata, include_regex = "^newdata")
    ...
    my_marginaleffects_wts_internal <- out[["my_marginaleffects_wts_internal"]]
    out[["my_marginaleffects_wts_internal"]] <- NULL
    ...
    stubcols <- c(
        ...
        "conf.high", "my_marginaleffects_wts",
    ...
    out <- set_my_marginaleffects_attributes(out, attr_cache = newdata_attr_cache)
...
get_predictions <- function(model,
    ...
    if (inherits(out$value, "data.frame")) {
        ...
        msg <- c(msg, "", "Bug Tracker: https://github.com/vincentarelbundock/my_marginaleffects/issues")
