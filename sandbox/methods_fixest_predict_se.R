...
get_predict.fixest <- function(model,
    ...
    if (inherits(pred, "data.frame")) {
        ...
        msg <- "Unable to extract predictions from a model of type `fixest`. Please report this problem, along with replicable code, on the `my_marginaleffects` issue tracker: https://github.com/vincentarelbundock/my_marginaleffects/issues"
